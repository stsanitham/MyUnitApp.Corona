	...
	function get_removeorblockDetails( response)
	    ...
	    function onCompletion(event)
		 ...
		 if id_value == "Remove Access" then
	        ...
	        local remove_successful= native.showAlert("Remove", "You are successful in removing the contact from the list", { CommonWords.ok} , onCompletion)

		 elseif id_value == "Block Access" then

		    print("response after blocking details ",Request_response)
			local block_successful = native.showAlert("Block", "You are successful in blocking the contact from the list", { CommonWords.ok} , onCompletion)
    ...
    function RequestGrantProcess( )
        ...
        print("value for access id : ",MyUnitBuzzRequestAccessId)
   	    ...
   	    print("reason for deny%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%",reasonfordeny)
   	    	...
   	    	Webservice.AccessPermissionDetails(Email,PhoneNumber,MkRankId,GetRquestAccessFrom,MailTemplate,Status,isSentMail,isSentText,ContactId,isaddedToContact,MyUnitBuzzRequestAccessId,reasonfordeny,get_removeorblockDetails)
