...
function GetDeleteMessageAlertPopup()
	    ...
	    AlertText = display.newText("Delete",0,0,native.systemFontBold,15)
	    AlertText.anchorX=0
	    ...
	    AlertContentText = display.newText("Are you sure you want to delete this message?",0,0,W-20,0,native.systemFont,14)
...
------------------------------remove or block buttons------------------------------------------
	...
	accept_button_text = display.newText(DeleteMessageGroup,"Yes, I want to delete",0,0,native.systemFont,14)
	...
	reject_button_text = display.newText(DeleteMessageGroup,"No, I dont want to delete",0,0,native.systemFont,14)
