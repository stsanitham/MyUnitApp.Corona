...
consumer_key = "EScR8AcEC2CTe5RNokSogX83A" -- key string goes here
consumer_secret = "F2IzBN5eOEArIHDGg36NaUTC62gOI9L5bOwvI0D0e79CeLaigc" -- secret string goes here


--[[for row in db:nrows("SELECT * FROM logindetails WHERE id=1") do
 print(row.TwitterToken)
consumer_key = row.TwitterToken -- key string goes here
consumer_secret = row.TwitterTokenSecret -- secret string goes here
...
--
local access_token = "435808403-q3Dp2FZKKIvxTPAfCT7dxZzSfUkEK96wiBkQdZ1s"
local access_token_secret = "YxkD2aUghETbUulBi746DDtbqlIg7UYOvACvJyC44Zbxj"
local user_id
local screen_name
...
function tweet(del, msg)
	...
	access_token = "435808403-q3Dp2FZKKIvxTPAfCT7dxZzSfUkEK96wiBkQdZ1s"
...
function doTweet()
	...
	function doTweetCallback( status, result )
		...
		delegate.twitterSuccess( values[1], screen_name, result )
