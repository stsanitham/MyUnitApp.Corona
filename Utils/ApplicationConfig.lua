...
local Applicationconfig = require("Utils."..AppMode..".ApplicationConfig")
...
ApplicationConfig.Version = "/iOS/1.2.7"	    --1.1.2
...
ApplicationConfig.GetMyUnitBuzzRequestAccesses = ApplicationConfig.BASE_URL.."/MyUnitBuzz/GetMyUnitBuzzRequestAccessesListScrollbyScroll"
...
ApplicationConfig.AddDocumentFromNativeAppDocumentLibrary = ApplicationConfig.BASE_URL.."/MyUnitBuzz/AddDocumentFromNativeAppDocumentLibrary"
